...
//User Controller
export const REGISTER_ACCOUNT = BASE_URL + '/user/register'

// Word Detail Controller
export const GET_WORD_DETAIL = BASE_URL + '/word'
...
export const UPDATE_A_CARD = BASE_URL + '/card'

//learn
export const LEARN_A_FLASHCARD = BASE_URL + '/flashcard/learn'
export const REMEMBER_A_FLASHCARD = BASE_URL + '/flashcard/remember'
export const FORGET_A_FLASHCARD = BASE_URL + '/flashcard/forget'
